...
# ── Config ───────────────────────────────────────────────────
BASE_URL    = "https://alms.alkamelsystems.com/"
SERIES_KEY  = "alms"
CATALOG_DIR = Path(r"C:\dev\openwec\catalog\alms")
RAW_DIR     = Path(r"C:\dev\openwec\raw\alms")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Asian LMS Collector")
