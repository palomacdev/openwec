...
# ── Config ───────────────────────────────────────────────────
BASE_URL    = "https://lemanscup.alkamelsystems.com/"
SERIES_KEY  = "lemanscup"
CATALOG_DIR = Path(r"C:\dev\openwec\catalog\lemanscup")
RAW_DIR     = Path(r"C:\dev\openwec\raw\lemanscup")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Le Mans Cup Collector")
